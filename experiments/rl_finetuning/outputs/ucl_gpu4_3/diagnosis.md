...
**Evidence:** 2/2 supporting ablations improved over baseline.
...
|---|---|---|---|
| attention_only | C | 0.6125 | +0.0375 |
| frozen_backbone | C | 0.6437 | +0.0687 |
| head_only | C | 0.6000 | +0.0250 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| attention_only | 0.6125 | +0.0375 | NEUTRAL |
| frozen_backbone | 0.6437 | +0.0687 | IMPROVEMENT |
| head_only | 0.6000 | +0.0250 | NEUTRAL |

*Pretrained score: 0.5750*
*Baseline RL score: 0.5750*

## Aggregate Verdict

Mixed results: 0/3 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.3654: RL gradient has useful signal.