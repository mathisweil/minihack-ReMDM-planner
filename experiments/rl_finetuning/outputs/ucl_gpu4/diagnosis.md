...
|---|---|---|---|
| attention_only | C | 0.6250 | +0.0875 |
| frozen_backbone | C | 0.5625 | +0.0250 |
| head_only | C | 0.5875 | +0.0500 |
| low_t | B | 0.5375 | +0.0000 |
...
**Gradient alignment** = +0.4383: RL gradient has useful signal.