...
|---|---|---|---|
| frozen_backbone | C | 0.4000 | -0.4000 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| frozen_backbone | 0.4000 | -0.4000 | COLLAPSE |

*Pretrained score: 0.8000*
*Baseline RL score: 0.8000*
...
**Gradient alignment** = +0.7998: RL gradient has useful signal.