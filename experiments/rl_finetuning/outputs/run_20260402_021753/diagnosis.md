...
|---|---|---|---|
| mixed_replay | A | 0.8500 | +0.1500 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| mixed_replay | 0.8500 | +0.1500 | IMPROVEMENT |

*Pretrained score: 0.7000*
*Baseline RL score: 0.7000*

## Aggregate Verdict

Mixed results: 0/1 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.7734: RL gradient has useful signal.