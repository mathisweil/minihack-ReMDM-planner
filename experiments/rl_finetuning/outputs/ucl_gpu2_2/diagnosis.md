...
|---|---|---|---|
| trust_region_kl | A | 0.5875 | -0.0500 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| trust_region_kl | 0.5875 | -0.0500 | NEUTRAL |

*Pretrained score: 0.6375*
*Baseline RL score: 0.6375*

## Aggregate Verdict

Mixed results: 0/1 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.8486: RL gradient has useful signal.