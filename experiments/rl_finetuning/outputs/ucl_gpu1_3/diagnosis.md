...
|---|---|---|---|
| lora | A | 0.6063 | +0.0063 |
| mixed_replay | A | 0.5562 | -0.0438 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| lora | 0.6063 | +0.0063 | NEUTRAL |
| mixed_replay | 0.5562 | -0.0438 | NEUTRAL |
...
**Gradient alignment** = +0.6583: RL gradient has useful signal.