...
|---|---|---|---|
| reward_model | D | 0.5500 | +0.0500 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| reward_model | 0.5500 | +0.0500 | IMPROVEMENT |

*Pretrained score: 0.5000*
*Baseline RL score: 0.5000*

## Aggregate Verdict

Mixed results: 0/1 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.4913: RL gradient has useful signal.