...
|---|---|---|---|
| baseline_rl | Baseline | 0.5375 | -0.1500 |
| ewc | A | 0.6375 | -0.0500 |
| kl_penalty | A | 0.5500 | -0.1375 |
...
*Pretrained score: 0.6875*
*Baseline RL score: 0.5375*

## Aggregate Verdict

Mixed results: 1/2 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.8872: RL gradient has useful signal.