...
| attention_only | C | 0.6167 | +0.0292 |
| baseline_rl | Baseline | 0.5625 | -0.0250 |
| bc_wins | B | 0.5708 | -0.0167 |
...
| layer_ablation_top3 | C | 0.5833 | -0.0042 |
...
| attention_only | 0.6167 | +0.0542 | IMPROVEMENT |
| baseline_rl | 0.5625 | +0.0000 | NEUTRAL |
| bc_wins | 0.5708 | +0.0083 | NEUTRAL |
...
| layer_ablation_top3 | 0.5833 | +0.0208 | NEUTRAL |
