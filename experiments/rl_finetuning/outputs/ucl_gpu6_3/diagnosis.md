...
|---|---|---|---|
| action_diversity | D | 0.5938 | -0.0562 |
| reward_model | D | 0.5625 | -0.0875 |
| running_stats | D | 0.5875 | -0.0625 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| action_diversity | 0.5938 | -0.0562 | NEUTRAL |
| reward_model | 0.5625 | -0.0875 | NEUTRAL |
| running_stats | 0.5875 | -0.0625 | NEUTRAL |

*Pretrained score: 0.6500*
*Baseline RL score: 0.6500*

## Aggregate Verdict

Mixed results: 0/3 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.8953: RL gradient has useful signal.