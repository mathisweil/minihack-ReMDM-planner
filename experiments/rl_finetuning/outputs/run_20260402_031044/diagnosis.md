...
|---|---|---|---|
| bc_wins | B | 0.6500 | +0.2000 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| bc_wins | 0.6500 | +0.2000 | IMPROVEMENT |

*Pretrained score: 0.4500*
*Baseline RL score: 0.4500*

## Aggregate Verdict

Mixed results: 0/1 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.3723: RL gradient has useful signal.