...
|---|---|---|---|
| gradient_surgery | B | 0.6375 | +0.1625 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| gradient_surgery | 0.6375 | +0.1625 | IMPROVEMENT |

*Pretrained score: 0.4750*
*Baseline RL score: 0.4750*

## Aggregate Verdict

Mixed results: 0/1 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.8040: RL gradient has useful signal.