...
|---|---|---|---|
| entropy_bonus | B | 0.5375 | -0.0750 |
| t_curriculum | B | 0.4750 | -0.1375 |
| trust_region_kl | A | 0.5500 | -0.0625 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| entropy_bonus | 0.5375 | -0.0750 | NEUTRAL |
| t_curriculum | 0.4750 | -0.1375 | COLLAPSE |
| trust_region_kl | 0.5500 | -0.0625 | NEUTRAL |
...
**Gradient alignment** = +0.8281: RL gradient has useful signal.