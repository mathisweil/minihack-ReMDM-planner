...
|---|---|---|---|
| baseline_rl | Baseline | 0.6750 | -0.0250 |
| ewc | A | 0.6250 | -0.0750 |
| llrd | A | 0.6750 | -0.0250 |
| lora | A | 0.5500 | -0.1500 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| baseline_rl | 0.6750 | +0.0000 | NEUTRAL |
| ewc | 0.6250 | -0.0500 | NEUTRAL |
| llrd | 0.6750 | +0.0000 | NEUTRAL |
| lora | 0.5500 | -0.1250 | COLLAPSE |

*Pretrained score: 0.7000*
*Baseline RL score: 0.6750*

## Aggregate Verdict

Mixed results: 1/3 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +0.6481: RL gradient has useful signal.