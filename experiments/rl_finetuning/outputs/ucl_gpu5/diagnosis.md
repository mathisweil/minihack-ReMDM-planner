...
|---|---|---|---|
| ffn_only | C | 0.6375 | +0.0250 |
| layer_ablation_top1 | C | 0.6000 | -0.0125 |
| layer_ablation_top2 | C | 0.6625 | +0.0500 |
| layer_ablation_top3 | C | 0.5500 | -0.0625 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| ffn_only | 0.6375 | +0.0250 | NEUTRAL |
| layer_ablation_top1 | 0.6000 | -0.0125 | NEUTRAL |
| layer_ablation_top2 | 0.6625 | +0.0500 | NEUTRAL |
| layer_ablation_top3 | 0.5500 | -0.0625 | NEUTRAL |
...
**Gradient alignment** = +0.4882: RL gradient has useful signal.