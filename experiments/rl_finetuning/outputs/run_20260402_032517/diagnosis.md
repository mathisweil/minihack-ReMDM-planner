...
|---|---|---|---|
| layer_ablation_top1 | C | 0.6000 | -0.1500 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| layer_ablation_top1 | 0.6000 | -0.1500 | COLLAPSE |

*Pretrained score: 0.7500*
*Baseline RL score: 0.7500*
...
**Gradient alignment** = +0.4644: RL gradient has useful signal.