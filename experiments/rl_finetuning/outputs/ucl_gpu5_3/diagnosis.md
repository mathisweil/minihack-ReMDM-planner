...
|---|---|---|---|
| layer_ablation_top1 | C | 0.6312 | +0.0312 |
| layer_ablation_top2 | C | 0.6375 | +0.0375 |
| layer_ablation_top3 | C | 0.6000 | +0.0000 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| layer_ablation_top1 | 0.6312 | +0.0312 | NEUTRAL |
| layer_ablation_top2 | 0.6375 | +0.0375 | NEUTRAL |
| layer_ablation_top3 | 0.6000 | +0.0000 | NEUTRAL |

*Pretrained score: 0.6000*
...
**Gradient alignment** = +0.5267: RL gradient has useful signal.