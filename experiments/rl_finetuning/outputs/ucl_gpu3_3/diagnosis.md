...
|---|---|---|---|
| advantage_clip | B | 0.4750 | -0.1375 |
| bc_wins | B | 0.6000 | -0.0125 |
| normalized_adv | B | 0.0688 | -0.5438 |

| Ablation | Score | Delta vs Baseline | Verdict |
|---|---|---|---|
| advantage_clip | 0.4750 | -0.1375 | COLLAPSE |
| bc_wins | 0.6000 | -0.0125 | NEUTRAL |
| normalized_adv | 0.0688 | -0.5438 | COLLAPSE |
...
Mixed results: 2/3 ablations collapsed. Check individual verdicts above.

**Gradient alignment** = +nan: RL gradient has useful signal.